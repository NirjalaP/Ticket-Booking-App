...
import { SearchIcon, MenuIcon, XIcon, User, Ticket, TicketPlus } from 'lucide-react'
...
border-gray-300/20 overflow-hidden transition-[width] duration-300 ${isOpen ? 'max-md:w-full': 'max-md:w-0'}` }>
    ...
    <div className='flex items-center gap-8'>
        ...
        {
            !user ? (<button onClick={openSignIn} className='px-4 py-1 sm:px-7 sm:py-2 bg-red-600 hover:bg-red-700 text-white transition rounded-full font-medium cursor-pointer'>Login</button>
